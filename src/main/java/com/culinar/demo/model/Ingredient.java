...
public enum Ingredient {
    ...
    Fish,
    PekingCabbage, Dill, Parsley, GreenLettuce, Mint, Spinach, Cilantro, GreenOnion, Sorrel, Nettle, BayLeaf,
    Buckwheat, Rice, Barley, Millet, Spelt, Cats, Peas, Hercules, Pasta,
    Milk, Kefir, Cheese, Butter,Curd, Cream, CottageCheese,
    Bread, Honey, Jam, Chocolate, Cocoa, VegetableOil, Eggs, Soda, TomatoPaste,
    Berries, Nuts, DriedFruits,
    Felix,
    Mushrooms,
